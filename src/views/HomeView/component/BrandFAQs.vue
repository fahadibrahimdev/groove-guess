...
<template>
  <section id="faqs" class="faqs-section flex items-center relative h-[840px] md:h-[600px] xl:h-[700px] 2xl:h-[900px]">
    <div class="container pt-20 2xl:pt-40 text-center">
        <div>
      ...
      <div class="faqs-wrapper flex flex-col gap-4 pd-5 md:px-10 xl:px-20 2xl:px-40 pt-20 2xl:pt-26">
        <div
